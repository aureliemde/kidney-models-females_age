"""Jacobian matrix computation for the OMCD Newton-Raphson solver.
...
def jacobi2_2icbOMC(n, x, fvec, ldfjac, iflag, epsfcn, numpar, pars, pt, idid, Lz, PTinitVol, xNaPiIIaPT, xNaPiIIcPT, xPit2PT):
    """Compute the dense finite-difference Jacobian of the OMCD residual.
    ...
    Args:
        ...
        iflag:      Solver flag (passed through to fcn2OMC)
    ...
    # zero = 0.0  # unused named constant; kept for reference
    ...
    for j in range(n):
        ...
        x[j] = temp + h
        wa1  = fcn2OMC(n, x, iflag, numpar, pars, pt, idid, Lz, PTinitVol, xNaPiIIaPT, xNaPiIIcPT, xPit2PT)
        x[j] = temp  # restore
